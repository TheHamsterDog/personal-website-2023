        ...
        <div className="home-projects-container">
            {
                projects.map((project, index) => {
                    return <div href={project.link}
                        ...
                        <img alt={project.title} loading="eager" src={project.image || "https://images.unsplash.com/photo-1528072164453-f4e8ef0d475a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1171&q=80"} className={"home-projects-container-each-background"} />
